...
@pytest.mark.parametrize("title, content, published", [
    ("New Post 1", "New Content 1", True),
    ("New Post 2", "New Content 2", False),
    ("New Post 3", "New Content 3", True),
])
...
def test_delete_other_user_post(authorized_client, test_posts, test_user, test_user2):
    # test_user is logged in, trying to delete test_user2's post
...
def test_update_unauthorized_user(client, test_posts):
    data = {
        "title": "Updated Title",
        "content": "Updated Content",
        "published": False
